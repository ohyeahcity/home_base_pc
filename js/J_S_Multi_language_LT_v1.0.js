...
function changeAllNavBarUIWording(arr,lang_index){
  ...
  document.getElementById('lang_port_title').innerHTML = arr[lang_index].lang_port_title;

  document.getElementById('lang_APPLIC_title').innerHTML = arr[lang_index].lang_APPLIC_title;

  document.getElementById('lang_iot_title').innerHTML = arr[lang_index].lang_iot_title;
  document.getElementById('lang_iot_content').innerHTML = arr[lang_index].lang_iot_content;
  document.getElementById('lang_photo_title').innerHTML = arr[lang_index].lang_photo_title;
  document.getElementById('lang_photo_content').innerHTML = arr[lang_index].lang_photo_content;
  document.getElementById('lang_movie_title').innerHTML = arr[lang_index].lang_movie_title;
  document.getElementById('lang_movie_content').innerHTML = arr[lang_index].lang_movie_content;
